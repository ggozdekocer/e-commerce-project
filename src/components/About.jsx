    ...
    return (
        <>
            <div className="flex flex-col items-center pt-50 gap-30 lg:grid lg:grid-cols-5 lg:px-15 lg:pt-0">
                ...
                <p className="text-xl text-custom-gray text-center lg:text-start!">We know how large objects will act, but things on a small scale just do not act that way.</p>
                <button className="bg-sky-500 px-10 py-3 rounded-lg! text-white text-lg!">Get Quote Now</button>
                </div>
                <img 
                src="src/assets/about-us-img1.png"
            ...
            <div className="flex flex-col items-center px-10 py-25 gap-10 lg:grid lg:grid-cols-5 lg:px-20 lg:gap-20">
                ...
                <p className="text-3xl font-bold text-detail-page px-8 text-center lg:p-0 lg:text-start!">Met minim Mollie non desert Alamo est sit cliquey dolor do met sent.</p>
                </div>
                <p className="text-custom-gray text-md pt-15 lg:col-span-3 lg:pt-0 lg:text-lg">Problems trying to resolve the conflict between the two major realms of Classical physics: Newtonian mechanics </p>
            </div>
            ...
            <div className="flex items-center justify-center px-8 py-20">
                ...
                />
                <img 
                src="src/assets/desktop-video.png"
                className="hidden lg:flex w-250 rounded-2xl"
                />
            </div>
            <div className="flex flex-col items-center px-10 py-20 gap-4">
                ...
                <p className="text-center text-lg text-custom-gray lg:px-60 lg:pb-16">Problems trying to resolve the conflict between the two major realms of Classical physics: Newtonian mechanics</p>
                <div className="lg:flex lg:flex-row lg:gap-10 lg:px-20">
                <div className="flex flex-col items-center pb-18">
                    <img 
                    src="src/assets/team-user-2.png"
                    className="py-3 h-70 object-cover"
                    />
            ...
            <div className="bg-light-gray pt-20">
                <div className="flex flex-col items-center text-center gap-5 px-10 lg:px-70">
                    ...
                    <p className="text-lg text-custom-gray lg:text-xl">Problems trying to resolve the conflict between the two major realms of Classical physics: Newtonian mechanics </p>
                </div>
                <Brands />
            </div>
        </>
